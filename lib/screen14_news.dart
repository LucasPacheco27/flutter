...
class NewsPage extends StatelessWidget {
  ...
  Widget _newsCard({
    ...
    required String url, // Novo parâmetro para URL
  }) {
    return InkWell(
  ...
  Future<void> _launchURL(String url) async {
    try {
      ...
      debugPrint('Error to open URL: $e');
      ...
      try {
        ...
        debugPrint('Error at the fallback: $e2');
      }
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  _newsCard(
                    ...
                    url: 'https://www.marketwatch.com/markets/europe-middle-east',
                  ),
